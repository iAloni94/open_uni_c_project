...
assembler.o: assembler.c assembler.h func.h param.h  utils.h
	${CC} ${CFLAGS} -c assembler.c

input.o: input.c assembler.h utils.h
	${CC} ${CFLAGS} -c input.c

param_check.o: param_check.c assembler.h param.h func.h utils.h
	${CC} ${CFLAGS} -c param_check.c

type_r_func.o: type_r_func.c assembler.h param.h  func.h
	${CC} ${CFLAGS} -c type_r_func.c

type_i_func.o: type_i_func.c assembler.h param.h  func.h
	${CC} ${CFLAGS} -c type_i_func.c

type_j_func.o: type_j_func.c assembler.h param.h 
