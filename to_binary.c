...
unsigned int i_binary_instruction(void *instruction, char type) {
    I *instruct = (I *)instruction;
    unsigned int my_32bit = 0;
    return my_32bit;
}
unsigned int j_binary_instruction(void *instruction, char type) {
    J *instruct = (J *)instruction;
    unsigned int my_32bit = 0;
    return my_32bit;
}