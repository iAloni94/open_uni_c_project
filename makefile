...
assembler: assembler.o input.o type_r_func.o type_i_func.o type_j_func.o param.o num_base.o utils.o
	${CC} ${CFLAGS} assembler.o -o assembler input.o type_r_func.o type_i_func.o type_j_func.o  param.o num_base.o utils.o
